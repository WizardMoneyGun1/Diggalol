...
getgenv().AimSpeed = 1
getgenv().CAMPREDICTION = 0.146140663325
getgenv().CAMJUMPPREDICTION = 0.5
...
function SendNotification(text)
    Notification:Notify(
        {Title = "Diggalol", Description = "coolest kid - "..text},
...
task.spawn(function()
    ...
    watermark:Update { "Diggalol", ScriptProperties.UserPanel.Status, frames .. " FPS", string.format("%s:%s %s", tonumber(os.date("%I")), os.date("%M"), os.date("%p")) }
